...
montyhall <- function( cambiar = TRUE){
  ...
  cat("Posicion elegida:",posicion, ";")
  
  descartables <- which(setdiff(Puertas, Puertas[posicion]) != 3) #posicion de puertas que pueden ser descartados
  cat("Puertas descartables:",descartables,";")
  
  puerta_descartada <- which(Puertas == sample(descartables,1)) #posicion de la puerta descartada
  
  cat("Puerta descartada:",puerta_descartada, ";")
  
  
  if(cambiar == TRUE){
    posicion <- sample(1:2,1)
  }
